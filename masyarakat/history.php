...
<head>
    ...
    <title>User/Riwayatlelang</title>
    <!-- CSS only -->
        ...
        <div class="card">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    FROM barang
                    INNER JOIN history_lelang
                    ON barang.id_barang = history_lelang.id_barang
                    where history_lelang.id_masyarakat = '".$_SESSION['id_masyarakat']."' ");
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?Php if ($data_lelang['id_pemenang'] == $_SESSION['id_masyarakat'] ): ?>
