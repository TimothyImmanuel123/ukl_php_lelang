...
<body style="background-color: white">
    ...
    <div class="card" style="margin: 20px;">
        <div class="card-header" style="background-color: #2F008C;"><h1>Data Barang</h1></div>
        <div class="card-body">
                    ...
                    while ($data_barang = mysqli_fetch_array($query_barang)) { ?>
                        <tr>
                            ...
                            <a href="detail_barang.php?id_barang=<?=$data_barang['id_barang'];?>" class="btn btn-success">detail barang</a> 
                                ...
                                <a href="proses_tutup.php?id_barang=<?=$data_barang['id_barang']?>" class="btn btn-danger"
                                onclick="return confirm('Apakah anda yakin menghentikan lelang?')">Tutup</a>
                                <a href="proses_buka.php?id_barang=<?=$data_barang['id_barang']?>" class="btn btn-danger"
                                onclick="return confirm('Apakah anda yakin menghentikan lelang?')">buka</a> 
