...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 290px  ;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <svg class="bi me-2" width="10" height="32"><img src="lelangicon.jpg" alt="" width="30" height="30" class="rounded-circle me-2"></svg>
      <span class="fs-4">Lelang OnlinE</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="home.php" class="nav-link active" aria-current="page">
          <svg class="bi me-2" width="50" height="50"><use xlink:href="#home"/></svg>
          Home
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white">
          <svg class="bi me-2" width="50" height="50"><use xlink:href="#speedometer2"/></svg>
          Dashboard
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white">
          <svg class="bi me-2" width="50" height="50"><use xlink:href="#table"/></svg>
          Orders
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white">
          <svg class="bi me-2" width="50" height="50"><use xlink:href="#grid"/></svg>
          Products
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white">
          <svg class="bi me-2" width="50" height="50"><use xlink:href="#people-circle"/></svg>
          Customers
        </a>
      </li>
      <a href="#" class="nav-link text-white">
          <svg class="bi me-2" width="50" height="50"></svg>
...
<body style="background-color: white">
    ...
    <div class="card" style="margin: 20px;">
        <div class="card-header" style="background-color: #e8c3b7;"><h1>Data</h1></div>
        <div class="card-body">
            <p>Kumpulan data data :</p>
            <form action="petugas.php" method="POST" style="padding-bottom: 15px;" class="d-flex">
